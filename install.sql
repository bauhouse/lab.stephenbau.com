...
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (11, 20, 'building-my-laboratory', 'Building My Laboratory');
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (10, 21, 'experimental', 'Experimental');
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (13, 22, 'grid-systems', 'Grid Systems');
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (18, 23, 'css-weekly-bar-charts', 'CSS Weekly Bar Charts');
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (19, 25, 'piano-sonata-symphony-ensemble', 'Piano Sonata Symphony Ensemble');
...
INSERT INTO`tbl_entries_data_15` (`id`, `entry_id`, `relation_id`) VALUES (11, 20, 11);
INSERT INTO`tbl_entries_data_15` (`id`, `entry_id`, `relation_id`) VALUES (10, 21, 11);
INSERT INTO`tbl_entries_data_15` (`id`, `entry_id`, `relation_id`) VALUES (13, 22, 11);
INSERT INTO`tbl_entries_data_15` (`id`, `entry_id`, `relation_id`) VALUES (19, 23, 11);
INSERT INTO`tbl_entries_data_15` (`id`, `entry_id`, `relation_id`) VALUES (21, 25, 11);
INSERT INTO`tbl_entries_data_15` (`id`, `entry_id`, `relation_id`) VALUES (20, 25, 9);
...
INSERT INTO`tbl_entries_data_16` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (2, 24, 'css_weekly_barchart_demo-5e8d4b160234b.jpg', 13394, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2020-04-07T20:55:02-07:00\";s:5:\"width\";i:562;s:6:\"height\";i:129;}');
INSERT INTO`tbl_entries_data_16` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (3, 26, 'symphony_ensembles-5e8d4b7f247c2.jpg', 146959, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2020-04-07T20:56:47-07:00\";s:5:\"width\";i:1141;s:6:\"height\";i:878;}');
...
INSERT INTO`tbl_entries_data_17` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (2, 24, 'CSS Weekly Bar Chart Demo', NULL);
INSERT INTO`tbl_entries_data_17` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (3, 26, 'Symphony Ensembles - Piano Sonata downloads page', NULL);
...
INSERT INTO`tbl_entries_data_18` (`id`, `entry_id`, `relation_id`) VALUES (11, 20, NULL);
INSERT INTO`tbl_entries_data_18` (`id`, `entry_id`, `relation_id`) VALUES (10, 21, NULL);
INSERT INTO`tbl_entries_data_18` (`id`, `entry_id`, `relation_id`) VALUES (13, 22, NULL);
INSERT INTO`tbl_entries_data_18` (`id`, `entry_id`, `relation_id`) VALUES (18, 23, NULL);
INSERT INTO`tbl_entries_data_18` (`id`, `entry_id`, `relation_id`) VALUES (19, 25, 26);
...
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (11, 20, 'In an effort to try something new, but still be able to build quickly, I\'ve simply installed the [Piano Sonata Symphony Ensemble](http://getsymphony.com/download/ensembles/view/33380/) designed by [Rodrigo Galindez](http://www.rodrigogalindez.com/) and built by [Fazal Khan](http://getsymphony.com/get-involved/member/Fazal/).\r\n\r\nHowever, I see that there are several missing features. I\'d like to have a list of links that I can maintain on the site. Maybe that should be maintained within the content of each blog post. I\'m just wondering what Fazal did to ensure that the images appear at the top of the post, but not at the bottom of the post. Perhaps the XSLT is looking for the first two paragraphs, then inserting the image after the second paragraph. Clever.\r\n\r\nAs [mentioned by Nick Dunn](http://www.symphony-cms.com/discuss/thread/31595/#position-7), the messages section is not being used by the ensemble, so that could be hooked in as well. I\'m still not sure about the Calendar Overlay extension. It requires a wide window to keep the Date panel from floating down and to the left.\r\n\r\nThere are some very nice touches in this ensemble. I was able to change the Twitter data source to point to my account and the ensemble just automatically pulled my Twitter XML feed, cached it and displayed my latest tweet on the site.\r\n\r\nI especially like the feature that allows the ability to let Symphony format images. With the click of a checkbox, an uploaded image will be resized to fit in the layout using the Just-In-Time Image Manipulation extension.', '<p>In an effort to try something new, but still be able to build quickly, I&#8217;ve simply installed the <a href=\"http://getsymphony.com/download/ensembles/view/33380/\">Piano Sonata Symphony Ensemble</a> designed by <a href=\"http://www.rodrigogalindez.com/\">Rodrigo Galindez</a> and built by <a href=\"http://getsymphony.com/get-involved/member/Fazal/\">Fazal Khan</a>.</p>\n\n<p>However, I see that there are several missing features. I&#8217;d like to have a list of links that I can maintain on the site. Maybe that should be maintained within the content of each blog post. I&#8217;m just wondering what Fazal did to ensure that the images appear at the top of the post, but not at the bottom of the post. Perhaps the XSLT is looking for the first two paragraphs, then inserting the image after the second paragraph. Clever.</p>\n\n<p>As <a href=\"http://www.symphony-cms.com/discuss/thread/31595/#position-7\">mentioned by Nick Dunn</a>, the messages section is not being used by the ensemble, so that could be hooked in as well. I&#8217;m still not sure about the Calendar Overlay extension. It requires a wide window to keep the Date panel from floating down and to the left.</p>\n\n<p>There are some very nice touches in this ensemble. I was able to change the Twitter data source to point to my account and the ensemble just automatically pulled my Twitter XML feed, cached it and displayed my latest tweet on the site.</p>\n\n<p>I especially like the feature that allows the ability to let Symphony format images. With the click of a checkbox, an uploaded image will be resized to fit in the layout using the Just-In-Time Image Manipulation extension.</p>\n');
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (10, 21, 'The reason for this site is my lack of organization as far my ability to remember all the projects that I have on the go. I am the Absent-Minded Designer.\r\n\r\nSo, in an effort to keep up to date on the latest developments and to evangelize the merits of [Symphony](http://getsymphony.com/) and [XSLT](http://getsymphony.com/explore/flexible-templating/) to my colleagues at [Domain7](http://www.domain7.com/) and the Web Standards / Open Source development community, I will be trying to keep an ongoing log of my work, experiments and discoveries. Let\'s see how long this experiment lasts.\r\n\r\n#####The Action Method\r\n\r\nI came across a beautifully designed set of sites for creatives across a wide range of disciplines from the [Behance Network](http://www.behance.com/), which basically looks like a platform for promoting their [Action Method](https://actionmethod.com/pages/about-us) application.\r\n\r\n> The Action Method is an intuitive approach to productivity, designed to help creative thinkers push their ideas into action. Based on the power of capturing and managing \"Action Steps\" (tasks you need to complete), Action Method ensures nothing falls through the cracks, and ideas are accomplished.\r\n\r\nIn an effort to go beyond the creative and actually get things done, remember what I\'ve done, and catalogue my findings for easy retrieval, I thought it would be very helpful to document things as I go.\r\n\r\n#####Experiments\r\n\r\nAs my workflow involves an ever expanding set of exercises to expand my horizons and build my skill set, I am finding it all the more challenging to keep all my thoughts focused on any one thing. I even created a domain dedicated to my design and development experiments: [DesignProjectX](http://www.designprojectx.com/).\r\n\r\nA site about learning by doing: This is my playground, my sandbox for projects that I am toying with. I learn by doing. So this is where I do some of my stuff.\r\n\r\nI love to experiment with new things. Design is my passion. I desire to create, inspire, transform, revolutionize. The tools of my experimentation are an Apple Mac G5, Compaq Presario, Adobe InDesign, Photoshop and Illustrator, Dreamweaver and Flash, XHTML, CSS, Apache, PHP, MySQL, Symphony, Joyent. My design is influenced by the Modernist roots of art and design at the Bauhaus, a school founded by Walter Gropius in 1919 in Weimar, Germany. The influence tends to show up less in design style, but more in my idealism and my hope to encourage social unity in diversity through the synthesis of art and technology.\r\n\r\n#####Evangelizing Symphony\r\n\r\nThis Post has been written using [Markdown](http://daringfireball.net/projects/markdown/) & has nice Typographic elements added using Tony Arnold\'s [Typogrify Extension](http://github.com/tonyarnold/typogrify/tree/master). Thanks to Symphony for [the cure for CMSing](http://getsymphony.com/discuss/thread/34636/#position-19).', '<p>The reason for this site is my lack of organization as far my ability to remember all the projects that I have on the go. I am the Absent-Minded Designer.</p>\n\n<p>So, in an effort to keep up to date on the latest developments and to evangelize the merits of <a href=\"http://getsymphony.com/\">Symphony</a> and <a href=\"http://getsymphony.com/explore/flexible-templating/\">XSLT</a> to my colleagues at <a href=\"http://www.domain7.com/\">Domain7</a> and the Web Standards / Open Source development community, I will be trying to keep an ongoing log of my work, experiments and discoveries. Let&#8217;s see how long this experiment lasts.</p>\n\n<h5>The Action Method</h5>\n\n<p>I came across a beautifully designed set of sites for creatives across a wide range of disciplines from the <a href=\"http://www.behance.com/\">Behance Network</a>, which basically looks like a platform for promoting their <a href=\"https://actionmethod.com/pages/about-us\">Action Method</a> application.</p>\n\n<blockquote>\n  <p>The Action Method is an intuitive approach to productivity, designed to help creative thinkers push their ideas into action. Based on the power of capturing and managing &#8220;Action Steps&#8221; (tasks you need to complete), Action Method ensures nothing falls through the cracks, and ideas are accomplished.</p>\n</blockquote>\n\n<p>In an effort to go beyond the creative and actually get things done, remember what I&#8217;ve done, and catalogue my findings for easy retrieval, I thought it would be very helpful to document things as I go.</p>\n\n<h5>Experiments</h5>\n\n<p>As my workflow involves an ever expanding set of exercises to expand my horizons and build my skill set, I am finding it all the more challenging to keep all my thoughts focused on any one thing. I even created a domain dedicated to my design and development experiments: <a href=\"http://www.designprojectx.com/\">DesignProjectX</a>.</p>\n\n<p>A site about learning by doing: This is my playground, my sandbox for projects that I am toying with. I learn by doing. So this is where I do some of my stuff.</p>\n\n<p>I love to experiment with new things. Design is my passion. I desire to create, inspire, transform, revolutionize. The tools of my experimentation are an Apple Mac G5, Compaq Presario, Adobe InDesign, Photoshop and Illustrator, Dreamweaver and Flash, XHTML, CSS, Apache, PHP, MySQL, Symphony, Joyent. My design is influenced by the Modernist roots of art and design at the Bauhaus, a school founded by Walter Gropius in 1919 in Weimar, Germany. The influence tends to show up less in design style, but more in my idealism and my hope to encourage social unity in diversity through the synthesis of art and technology.</p>\n\n<h5>Evangelizing Symphony</h5>\n\n<p>This Post has been written using <a href=\"http://daringfireball.net/projects/markdown/\">Markdown</a> &amp; has nice Typographic elements added using Tony Arnold&#8217;s <a href=\"http://github.com/tonyarnold/typogrify/tree/master\">Typogrify Extension</a>. Thanks to Symphony for <a href=\"http://getsymphony.com/discuss/thread/34636/#position-19\">the cure for CMSing</a>.</p>\n');
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (13, 22, 'Design on the web is a different animal than design for print. Grid systems provide a basic framework for page layout that provides a structure, consistency and coherence to a design. However, HTML and CSS provide some challenges when dealing with complex layout structures. Best practices in web development means that the methods once used for layout by using tables to establish grid structures have fallen out of favour and have been replaced by POSH -- Plain Old Semantic HTML. Many site layouts created during the early development of Web Standards and the early adoption of CSS and semantic markup favoured a simple one-, two- or sometimes 3-column site structure. It may be a good idea to keep layouts much simpler.\r\n\r\nHowever, designers like to have the flexibility of a strong grid system to help give layouts a much more refined and sophisticated aesthetic.\r\n\r\nSeveral CSS frameworks are available to help build layouts quickly and easily, without worrying about whether the layouts will work across various browsers.', '<p>Design on the web is a different animal than design for print. Grid systems provide a basic framework for page layout that provides a structure, consistency and coherence to a design. However, HTML and CSS provide some challenges when dealing with complex layout structures. Best practices in web development means that the methods once used for layout by using tables to establish grid structures have fallen out of favour and have been replaced by POSH &#8212; Plain Old Semantic HTML. Many site layouts created during the early development of Web Standards and the early adoption of CSS and semantic markup favoured a simple one-, two- or sometimes 3-column site structure. It may be a good idea to keep layouts much simpler.</p>\n\n<p>However, designers like to have the flexibility of a strong grid system to help give layouts a much more refined and sophisticated aesthetic.</p>\n\n<p>Several CSS frameworks are available to help build layouts quickly and easily, without worrying about whether the layouts will work across various browsers.</p>\n');
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (18, 23, 'We were tasked with the challenge of building a site that could get people in the mind of improving their health. With the subject of wellness in mind, we would build a site that would enable participants to bring together teams of people who could encourage each other to focus on improving each other\'s lives through specific challenges. One challenge would be a step challenge.\r\n\r\nIn the development of the application, I came up with a layout that incorporated views of an individual\'s progress over a certain number of days and weeks. When I was dreaming up how the data should be visualized, I looked up examples of CSS bar charts, and Eric Meyer\'s [CSS Vertical Bar Charts](http://meyerweb.com/eric/css/edge/bargraph/demo.html) showed up in the search results. Well, that gave me some confidence to [mockup a solution](http://mockups.domain7.com/clac/wellness/layouts/009/progress.html) that could rely primarily on some already documented methods to represent bar graphs with CSS.\r\n\r\nThe next challenge was to actually take what Eric Meyer had created and develop a reusable snippet of HTML with enough hooks to be able to create a bubble tooltip that displayed the data associated with each data point in the bar chart.\r\n\r\n![CSS Weekly Bar Chart Demo](/workspace/uploads/css_weekly_barchart_demo-5e8d4b160234b.jpg)\r\n\r\nI was pleasantly surprised by the result. Now, this has been tested only in Mac Safari and Firefox. There are problems to be expected in Internet Explorer, particular IE6, since the demo relies on support for the CSS `content` property and the `:before` pseudo class.  \r\n\r\n[View the demo](/lab/experiments/css/barcharts/weekly/)', '<p>We were tasked with the challenge of building a site that could get people in the mind of improving their health. With the subject of wellness in mind, we would build a site that would enable participants to bring together teams of people who could encourage each other to focus on improving each other&#8217;s lives through specific challenges. One challenge would be a step challenge.</p>\n\n<p>In the development of the application, I came up with a layout that incorporated views of an individual&#8217;s progress over a certain number of days and weeks. When I was dreaming up how the data should be visualized, I looked up examples of CSS bar charts, and Eric Meyer&#8217;s <a href=\"http://meyerweb.com/eric/css/edge/bargraph/demo.html\">CSS Vertical Bar Charts</a> showed up in the search results. Well, that gave me some confidence to <a href=\"http://mockups.domain7.com/clac/wellness/layouts/009/progress.html\">mockup a solution</a> that could rely primarily on some already documented methods to represent bar graphs with CSS.</p>\n\n<p>The next challenge was to actually take what Eric Meyer had created and develop a reusable snippet of HTML with enough hooks to be able to create a bubble tooltip that displayed the data associated with each data point in the bar chart.</p>\n\n<p><img src=\"/workspace/uploads/css_weekly_barchart_demo-5e8d4b160234b.jpg\" alt=\"CSS Weekly Bar Chart Demo\" /></p>\n\n<p>I was pleasantly surprised by the result. Now, this has been tested only in Mac Safari and Firefox. There are problems to be expected in Internet Explorer, particular IE6, since the demo relies on support for the CSS <code>content</code> property and the <code>:before</code> pseudo class.</p>\n\n<p><a href=\"/lab/experiments/css/barcharts/weekly/\">View the demo</a></p>\n');
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (19, 25, 'As [mentioned previously](/lab/log/articles/building-my-laboratory), I am building this site on the [Piano Sonata Symphony Ensemble](http://symphony-cms.com/download/ensembles/view/33380/) designed by [Rodrigo Galindez](http://www.rodrigogalindez.com/) and adapted for Symphony by [Fazal Khan](http://symphony-cms.com/get-involved/member/Fazal/).\r\n\r\nI also mentioned that there were some items that I felt were missing. Here\'s what I have done so far to add some missing features.\r\n\r\n#####Change Log\r\n\r\n11 December 2009\r\n\r\n* Create a custom 403 Forbidden layout\r\n* Create a custom 404 Page Not Found layout\r\n* Add Drafts page for logged in users to view unpublished articles\r\n* Modify `get-article` utility to link to Drafts if the article has not yet been published\r\n* Display Edit link for articles if logged in\r\n* Remove filter from Tags data source, since I want all tags to be listed\r\n* Add filter to the Archive: Listing data source to display only published articles\r\n* CSS to format code blocks and `current` navigation items\r\n\r\n##### Custom 403 Forbidden Page\r\n\r\nThe XSL stylesheet for the forbidden page looks like this:\r\n\r\n	<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n	<xsl:stylesheet version=\"1.0\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\">\r\n	\r\n		<xsl:import href=\"../utilities/master.xsl\"/>\r\n		<xsl:import href=\"../utilities/get-article.xsl\"/>\r\n		<xsl:import href=\"../utilities/get-notes.xsl\"/>\r\n		<xsl:import href=\"../utilities/get-comments.xsl\"/>\r\n	\r\n		<xsl:template match=\"data\">\r\n			<div id=\"content\" class=\"col span-9\">\r\n				<h2>403 Error</h2>\r\n				<h3 class=\"script\">Forbidden</h3>\r\n				<p>Have you been poking around where you shouldn\'t be?  \r\n				Head back to <a href=\"{$root}/\">home</a>  \r\n				or <a href=\"{$root}/about/\">contact</a> me.</p>\r\n			</div>\r\n		</xsl:template>\r\n	\r\n	</xsl:stylesheet>\r\n\r\n##### Custom 404 Not Found Page\r\n\r\nThe XSL stylesheet for the 404 error page looks like this:\r\n\r\n	<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n	<xsl:stylesheet version=\"1.0\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\">\r\n	\r\n		<xsl:import href=\"../utilities/master.xsl\"/>\r\n		<xsl:import href=\"../utilities/get-article.xsl\"/>\r\n		<xsl:import href=\"../utilities/get-notes.xsl\"/>\r\n		<xsl:import href=\"../utilities/get-comments.xsl\"/>\r\n	\r\n		<xsl:template match=\"data\">\r\n			<div id=\"content\" class=\"col span-9\">\r\n				<h2>404 Error</h2>\r\n				<h3 class=\"script\">Page Not Found</h3>\r\n				<p>Head back to <a href=\"{$root}/\">home</a> \r\n				or <a href=\"{$root}/about/\">contact</a> me.</p>\r\n			</div>\r\n		</xsl:template>\r\n	\r\n	</xsl:stylesheet>\r\n\r\n\r\n##### Drafts Page\r\n\r\nThe Drafts page template is not much different from the template for the Home page. The main difference is in the `select` attribute of the `xsl:apply-templates` instruction, where the data source is `drafts`, rather than  `homepage-articles`.\r\n\r\n	<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n	<xsl:stylesheet version=\"1.0\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\">\r\n	\r\n		<xsl:import href=\"../utilities/master.xsl\"/>\r\n		<xsl:import href=\"../utilities/get-article.xsl\"/>\r\n		<xsl:import href=\"../utilities/get-notes.xsl\"/>\r\n		<xsl:import href=\"../utilities/get-comments.xsl\"/>\r\n	\r\n		<xsl:template match=\"data\">\r\n			<div id=\"content\" class=\"col span-9\">\r\n				<h2>Drafts</h2>\r\n				<h3 class=\"script\">These articles are yet to be published</h3>\r\n				<p>Head back to <a href=\"{$root}/\">home</a> \r\n				or <a href=\"{$root}/about/\">contact</a> me.</p>\r\n				<xsl:apply-templates select=\"drafts/entry\" mode=\"article\"/>\r\n			</div>\r\n			<div id=\"sidebar\" class=\"col last span-3\">\r\n				<xsl:call-template name=\"category\"/>\r\n				<xsl:call-template name=\"tag\"/>\r\n				<xsl:call-template name=\"external-links\"/>\r\n			</div>\r\n		</xsl:template>\r\n	\r\n	</xsl:stylesheet>\r\n \r\n#####Drafts Articles\r\n\r\nArticles that have not yet been published should not be linked to the Articles page. Clicking on the titles of these articles will result in 404 Page Not Found error. To solve this issue, I created a parameter, under the import instructions, to determine where the links should point to based on the value of the `$current-page` parameter. Basically, this is saying, \"If the current page is Drafts, set the `$publish-page` parameter to `drafts`.\"\r\n\r\n	<xsl:import href=\"typography.xsl\"/>\r\n	<xsl:import href=\"get-images.xsl\"/>\r\n\r\n	<xsl:param name=\"publish-page\">\r\n		<xsl:choose>\r\n			<xsl:when test=\"$current-page = \'drafts\'\">drafts</xsl:when>\r\n			<xsl:otherwise>articles</xsl:otherwise>\r\n		</xsl:choose>\r\n	</xsl:param>\r\n	\r\nThen the title of the post can have a link that is dynamically generated with a link to the appropriate page (notice the `$publish-page` parameter added as an attribute value template:\r\n\r\n	<h3>\r\n		<a href=\"{$root}/{$publish-page}/{title/@handle}\">\r\n			<xsl:value-of select=\"title\"/>\r\n		</a>\r\n	</h3>\r\n\r\n#####Edit Link\r\n\r\nFor logged-in users, an Edit link can be added to link directly to the Symphony admin, thanks to the clean URLs used by all admin pages. The following conditional instruction in the `get-article` utility inserts the `id` to display the edit page for an entry in the Articles section.\r\n\r\n	<xsl:if test=\"/data/events/login-info/@logged-in = \'true\'\">\r\n		<li><a href=\"{$root}/symphony/publish/articles/edit/{@id}/\">Edit</a></li>\r\n	</xsl:if>  \r\n\r\n#####CSS\r\n\r\nI also added some rules to the `master.css` file. I added a rule for anchors with a class of \"current\" to display selected navigation items in the same blue as the hover state for anchors. For now, this is only showing up on [demo pages](http://sym.domain7.com/lab/experiments/css/barcharts/weekly/) in the experiments directory that I have created as HTML pages outside of Symphony, which are still referring to the same CSS as the Symphony templates.\r\n\r\n	a:hover,\r\n	a.current {\r\n		color: #0F83DB;\r\n	}\r\n\r\nPlus, I added some formatting to display code blocks as green type against a dark background (with rounded corners for Firefox, Safari, and any browsers that support CSS3 properties):\r\n\r\n	pre {\r\n		white-space: normal;\r\n		margin-bottom: 1em;\r\n	}\r\n	\r\n	pre code {\r\n		display: block;\r\n		white-space: pre;\r\n		padding: 1em;\r\n		background: #333;\r\n		color: #0f0;\r\n		font-size: 1.3em;\r\n		overflow-x: auto;\r\n		-moz-border-radius: 1em;\r\n		-webkit-border-radius: 1em;\r\n		border-radius: 1em;\r\n	}\r\n', '<p>As <a href=\"/lab/log/articles/building-my-laboratory\">mentioned previously</a>, I am building this site on the <a href=\"http://symphony-cms.com/download/ensembles/view/33380/\">Piano Sonata Symphony Ensemble</a> designed by <a href=\"http://www.rodrigogalindez.com/\">Rodrigo Galindez</a> and adapted for Symphony by <a href=\"http://symphony-cms.com/get-involved/member/Fazal/\">Fazal Khan</a>.</p>\n\n<p>I also mentioned that there were some items that I felt were missing. Here&#8217;s what I have done so far to add some missing features.</p>\n\n<h5>Change Log</h5>\n\n<p>11 December 2009</p>\n\n<ul>\n<li>Create a custom 403 Forbidden layout</li>\n<li>Create a custom 404 Page Not Found layout</li>\n<li>Add Drafts page for logged in users to view unpublished articles</li>\n<li>Modify <code>get-article</code> utility to link to Drafts if the article has not yet been published</li>\n<li>Display Edit link for articles if logged in</li>\n<li>Remove filter from Tags data source, since I want all tags to be listed</li>\n<li>Add filter to the Archive: Listing data source to display only published articles</li>\n<li>CSS to format code blocks and <code>current</code> navigation items</li>\n</ul>\n\n<h5>Custom 403 Forbidden Page</h5>\n\n<p>The XSL stylesheet for the forbidden page looks like this:</p>\n\n<pre><code>&lt;?xml version=\"1.0\" encoding=\"UTF-8\"?&gt;\n&lt;xsl:stylesheet version=\"1.0\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\"&gt;\n\n    &lt;xsl:import href=\"../utilities/master.xsl\"/&gt;\n    &lt;xsl:import href=\"../utilities/get-article.xsl\"/&gt;\n    &lt;xsl:import href=\"../utilities/get-notes.xsl\"/&gt;\n    &lt;xsl:import href=\"../utilities/get-comments.xsl\"/&gt;\n\n    &lt;xsl:template match=\"data\"&gt;\n        &lt;div id=\"content\" class=\"col span-9\"&gt;\n            &lt;h2&gt;403 Error&lt;/h2&gt;\n            &lt;h3 class=\"script\"&gt;Forbidden&lt;/h3&gt;\n            &lt;p&gt;Have you been poking around where you shouldn\'t be?  \n            Head back to &lt;a href=\"{$root}/\"&gt;home&lt;/a&gt;  \n            or &lt;a href=\"{$root}/about/\"&gt;contact&lt;/a&gt; me.&lt;/p&gt;\n        &lt;/div&gt;\n    &lt;/xsl:template&gt;\n\n&lt;/xsl:stylesheet&gt;\n</code></pre>\n\n<h5>Custom 404 Not Found Page</h5>\n\n<p>The XSL stylesheet for the 404 error page looks like this:</p>\n\n<pre><code>&lt;?xml version=\"1.0\" encoding=\"UTF-8\"?&gt;\n&lt;xsl:stylesheet version=\"1.0\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\"&gt;\n\n    &lt;xsl:import href=\"../utilities/master.xsl\"/&gt;\n    &lt;xsl:import href=\"../utilities/get-article.xsl\"/&gt;\n    &lt;xsl:import href=\"../utilities/get-notes.xsl\"/&gt;\n    &lt;xsl:import href=\"../utilities/get-comments.xsl\"/&gt;\n\n    &lt;xsl:template match=\"data\"&gt;\n        &lt;div id=\"content\" class=\"col span-9\"&gt;\n            &lt;h2&gt;404 Error&lt;/h2&gt;\n            &lt;h3 class=\"script\"&gt;Page Not Found&lt;/h3&gt;\n            &lt;p&gt;Head back to &lt;a href=\"{$root}/\"&gt;home&lt;/a&gt; \n            or &lt;a href=\"{$root}/about/\"&gt;contact&lt;/a&gt; me.&lt;/p&gt;\n        &lt;/div&gt;\n    &lt;/xsl:template&gt;\n\n&lt;/xsl:stylesheet&gt;\n</code></pre>\n\n<h5>Drafts Page</h5>\n\n<p>The Drafts page template is not much different from the template for the Home page. The main difference is in the <code>select</code> attribute of the <code>xsl:apply-templates</code> instruction, where the data source is <code>drafts</code>, rather than  <code>homepage-articles</code>.</p>\n\n<pre><code>&lt;?xml version=\"1.0\" encoding=\"UTF-8\"?&gt;\n&lt;xsl:stylesheet version=\"1.0\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\"&gt;\n\n    &lt;xsl:import href=\"../utilities/master.xsl\"/&gt;\n    &lt;xsl:import href=\"../utilities/get-article.xsl\"/&gt;\n    &lt;xsl:import href=\"../utilities/get-notes.xsl\"/&gt;\n    &lt;xsl:import href=\"../utilities/get-comments.xsl\"/&gt;\n\n    &lt;xsl:template match=\"data\"&gt;\n        &lt;div id=\"content\" class=\"col span-9\"&gt;\n            &lt;h2&gt;Drafts&lt;/h2&gt;\n            &lt;h3 class=\"script\"&gt;These articles are yet to be published&lt;/h3&gt;\n            &lt;p&gt;Head back to &lt;a href=\"{$root}/\"&gt;home&lt;/a&gt; \n            or &lt;a href=\"{$root}/about/\"&gt;contact&lt;/a&gt; me.&lt;/p&gt;\n            &lt;xsl:apply-templates select=\"drafts/entry\" mode=\"article\"/&gt;\n        &lt;/div&gt;\n        &lt;div id=\"sidebar\" class=\"col last span-3\"&gt;\n            &lt;xsl:call-template name=\"category\"/&gt;\n            &lt;xsl:call-template name=\"tag\"/&gt;\n            &lt;xsl:call-template name=\"external-links\"/&gt;\n        &lt;/div&gt;\n    &lt;/xsl:template&gt;\n\n&lt;/xsl:stylesheet&gt;\n</code></pre>\n\n<h5>Drafts Articles</h5>\n\n<p>Articles that have not yet been published should not be linked to the Articles page. Clicking on the titles of these articles will result in 404 Page Not Found error. To solve this issue, I created a parameter, under the import instructions, to determine where the links should point to based on the value of the <code>$current-page</code> parameter. Basically, this is saying, &#8220;If the current page is Drafts, set the <code>$publish-page</code> parameter to <code>drafts</code>.&#8221;</p>\n\n<pre><code>&lt;xsl:import href=\"typography.xsl\"/&gt;\n&lt;xsl:import href=\"get-images.xsl\"/&gt;\n\n&lt;xsl:param name=\"publish-page\"&gt;\n    &lt;xsl:choose&gt;\n        &lt;xsl:when test=\"$current-page = \'drafts\'\"&gt;drafts&lt;/xsl:when&gt;\n        &lt;xsl:otherwise&gt;articles&lt;/xsl:otherwise&gt;\n    &lt;/xsl:choose&gt;\n&lt;/xsl:param&gt;\n</code></pre>\n\n<p>Then the title of the post can have a link that is dynamically generated with a link to the appropriate page (notice the <code>$publish-page</code> parameter added as an attribute value template:</p>\n\n<pre><code>&lt;h3&gt;\n    &lt;a href=\"{$root}/{$publish-page}/{title/@handle}\"&gt;\n        &lt;xsl:value-of select=\"title\"/&gt;\n    &lt;/a&gt;\n&lt;/h3&gt;\n</code></pre>\n\n<h5>Edit Link</h5>\n\n<p>For logged-in users, an Edit link can be added to link directly to the Symphony admin, thanks to the clean URLs used by all admin pages. The following conditional instruction in the <code>get-article</code> utility inserts the <code>id</code> to display the edit page for an entry in the Articles section.</p>\n\n<pre><code>&lt;xsl:if test=\"/data/events/login-info/@logged-in = \'true\'\"&gt;\n    &lt;li&gt;&lt;a href=\"{$root}/symphony/publish/articles/edit/{@id}/\"&gt;Edit&lt;/a&gt;&lt;/li&gt;\n&lt;/xsl:if&gt;  \n</code></pre>\n\n<h5>CSS</h5>\n\n<p>I also added some rules to the <code>master.css</code> file. I added a rule for anchors with a class of &#8220;current&#8221; to display selected navigation items in the same blue as the hover state for anchors. For now, this is only showing up on <a href=\"http://sym.domain7.com/lab/experiments/css/barcharts/weekly/\">demo pages</a> in the experiments directory that I have created as HTML pages outside of Symphony, which are still referring to the same CSS as the Symphony templates.</p>\n\n<pre><code>a:hover,\na.current {\n    color: #0F83DB;\n}\n</code></pre>\n\n<p>Plus, I added some formatting to display code blocks as green type against a dark background (with rounded corners for Firefox, Safari, and any browsers that support CSS3 properties):</p>\n\n<pre><code>pre {\n    white-space: normal;\n    margin-bottom: 1em;\n}\n\npre code {\n    display: block;\n    white-space: pre;\n    padding: 1em;\n    background: #333;\n    color: #0f0;\n    font-size: 1.3em;\n    overflow-x: auto;\n    -moz-border-radius: 1em;\n    -webkit-border-radius: 1em;\n    border-radius: 1em;\n}\n</code></pre>\n');
...
INSERT INTO`tbl_entries_data_3` (`id`, `entry_id`, `value`) VALUES (11, 20, 'yes');
INSERT INTO`tbl_entries_data_3` (`id`, `entry_id`, `value`) VALUES (10, 21, 'yes');
INSERT INTO`tbl_entries_data_3` (`id`, `entry_id`, `value`) VALUES (13, 22, 'no');
INSERT INTO`tbl_entries_data_3` (`id`, `entry_id`, `value`) VALUES (18, 23, 'yes');
INSERT INTO`tbl_entries_data_3` (`id`, `entry_id`, `value`) VALUES (19, 25, 'yes');
...
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (11, 20, '2009-12-09T10:29:00-08:00', '2009-12-09 18:29:00');
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (10, 21, '2009-12-09T10:30:00-08:00', '2009-12-09 18:30:00');
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (13, 22, '2009-12-09T13:02:00-08:00', '2009-12-09 21:02:00');
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (18, 23, '2009-12-09T14:11:00-08:00', '2009-12-09 22:11:00');
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (19, 25, '2009-12-11T10:17:00-08:00', '2009-12-11 18:17:00');
...
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `value`) VALUES (11, 20, 'no');
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `value`) VALUES (10, 21, 'no');
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `value`) VALUES (13, 22, 'no');
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `value`) VALUES (18, 23, 'no');
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `value`) VALUES (19, 25, 'yes');
...
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `handle`, `value`) VALUES (20, 20, 'symphony', 'Symphony');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `handle`, `value`) VALUES (19, 20, 'lab', 'Lab');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `handle`, `value`) VALUES (18, 21, 'html', 'HTML');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `handle`, `value`) VALUES (17, 21, 'css', 'CSS');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `handle`, `value`) VALUES (24, 22, 'html', 'HTML');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `handle`, `value`) VALUES (23, 22, 'css', 'CSS');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `handle`, `value`) VALUES (34, 23, 'html', 'HTML');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `handle`, `value`) VALUES (33, 23, 'css', 'CSS');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `handle`, `value`) VALUES (35, 25, 'symphony', 'Symphony');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `handle`, `value`) VALUES (36, 25, 'xslt', 'XSLT');
...
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `modification_author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (20, 1, 1, 1, '2020-04-07 16:05:04', '2020-04-07 23:05:04', '2020-04-07 16:11:09', '2020-04-07 23:11:09');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `modification_author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (21, 1, 1, 1, '2020-04-07 16:07:11', '2020-04-07 23:07:11', '2020-04-07 16:09:32', '2020-04-07 23:09:32');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `modification_author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (22, 1, 1, 1, '2020-04-07 17:38:15', '2020-04-08 00:38:15', '2020-04-07 17:39:16', '2020-04-08 00:39:16');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `modification_author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (23, 1, 1, 1, '2020-04-07 17:40:07', '2020-04-08 00:40:07', '2020-04-07 20:55:30', '2020-04-08 03:55:30');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `modification_author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (24, 4, 1, 1, '2020-04-07 20:42:11', '2020-04-08 03:42:11', '2020-04-07 20:55:02', '2020-04-08 03:55:02');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `modification_author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (25, 1, 1, 1, '2020-04-07 20:45:01', '2020-04-08 03:45:01', '2020-04-07 20:57:05', '2020-04-08 03:57:05');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `modification_author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (26, 4, 1, 1, '2020-04-07 20:56:47', '2020-04-08 03:56:47', '2020-04-07 20:56:47', '2020-04-08 03:56:47');
...
INSERT INTO`tbl_pages` (`id`, `parent`, `title`, `handle`, `path`, `params`, `data_sources`, `events`, `sortorder`) VALUES (2, NULL, 'Articles', 'articles', NULL, 'entry/cat', 'about_me,article,categories,comments,logged_in_author,navigation,tags,website_owner,elsewhere,article_image', NULL, 2);
INSERT INTO`tbl_pages` (`id`, `parent`, `title`, `handle`, `path`, `params`, `data_sources`, `events`, `sortorder`) VALUES (3, NULL, 'Archive', 'archive', NULL, 'year', 'archive,categories,logged_in_author,navigation,tags,website_owner,article_image', NULL, 3);
INSERT INTO`tbl_pages` (`id`, `parent`, `title`, `handle`, `path`, `params`, `data_sources`, `events`, `sortorder`) VALUES (4, 3, 'Categories', 'category', 'archive', 'category', 'about_me,all_categories,archive_listing,categories,logged_in_author,navigation,tags,website_owner,article_image', NULL, 4);
INSERT INTO`tbl_pages` (`id`, `parent`, `title`, `handle`, `path`, `params`, `data_sources`, `events`, `sortorder`) VALUES (5, 3, 'Tag', 'tag', 'archive', 'tag', 'about_me,archive_listing,categories,logged_in_author,navigation,tags,website_owner,article_image', NULL, 5);
